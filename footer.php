        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact" data-aos="fade-up">
            ...
            <p>
              ...
              <strong>Email:</strong> ahnur@email.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="200">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Pengiriman Barang</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Lacak Pengiriman Barang</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-links" data-aos="fade-up" data-aos-delay="300">
            ...
            <p>Anda Bisa Cari Tahu Tentang Kami di Social Network</p>
